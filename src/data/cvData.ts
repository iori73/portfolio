...
export const cvData: CVData = {
  ...
  workExperience: [
    ...
    },
    {
      ...
      endDate: '2025-03',
      summary: {
        en: 'Joined as a design intern while still at university. Shipped client work across consumer electronics, beauty, and public-sector digital, plus a self-initiated internal data visualization project.',
        jp: '大学在学中にデザインインターンとして参画。大手電機・化粧品・公共デジタル領域のクライアントワークに加え、自ら起案した社内データ可視化プロジェクトを担当。',
      },
      projects: [
        {
          ...
          detail: {
            ...
            outcome: {
              en: [
                'Unified the visualization rules for color, legend, axis, unit, and annotation placement, so readability improved without breaking the existing structure.',
        ...
        },
        {
          ...
          detail: {
            ...
            deliverables: {
              en: [
                'Individual page specifications for every screen in the service, plus an overall screen-flow diagram covering the whole product.',
              ...
              jp: [
                'サービス全画面分の個別ページ仕様と、プロダクト全体を網羅する画面遷移図。',
            ...
            outcome: {
              en: [
                ...
                'Each phase, from kickoff through build to release, had one unambiguous latest version to reference.',
              ],
              jp: [
    ...
    },
    {
      ...
      position: {
        en: 'Assistant, Development Department',
        jp: '開発部アシスタント',
      },
      employmentType: {
        en: 'Internship',
      ...
      endDate: '2024-03',
      summary: {
        en: 'Worked as an assistant in the development department. Learned the basics of the product development process and team collaboration, which became the foundation for the UI/UX design career that followed.',
        jp: 'インターンとして開発部のアシスタント業務に従事。プロダクト開発の現場で基礎的な開発プロセスとチームワークを学び、後のUI/UXデザインキャリアの基盤となった期間。',
      },
    },
  ],
  education: [
