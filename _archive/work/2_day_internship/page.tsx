  ...
  const formatScenarioText = (text: string) => {
    ...
    return parts.map((part, index) => {
      if (part === '{A}') {
        ...
        return (
          <span key={index} className="text-[#6b88ff] font-semibold">
            B
          </span>
        );
      } else if (part === '{C}') {
      ...
      <section className="  pt-4 pb-8">
        <div className="max-w-[896px] w-full mx-auto">
          <div className="flex items-center gap-6 mb-4 flex-wrap md:flex-nowrap">
            <h1 className="text-heading-2xl md:text-heading-3xl font-merriweather font-semibold">2 Day Internship</h1>
            <div className="flex gap-2">
              <span className="text-body-lg font-space-mono px-2 py-1 rounded-[16px] bg-[#f5f5f7] text-[#696969]">
                UI
              </span>
              <span className="text-body-lg font-space-mono px-2 py-1 rounded-[16px] bg-[#f5f5f7] text-[#696969]">
                Rapid Design
          ...
          {/* 説明文: Body/XL_140 */}
          <p className={`text-body-lg md:text-body-xl ${bodyFont.className} text-gray-600 mb-8`} style={bodyFont.style}>{t('internshipDescription')}</p>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div>
              {/* キャプション: Caption/XL_120 (font-space-mono) */}
              <span className="text-caption-lg font-space-mono text-gray-500 mb-2 block">Timeline</span>
              {/* 小テキスト: Body/L_140 */}
              <p className="text-body-base md:text-body-lg ">{t('internTimeline')}</p>
            </div>
            <div>
              <span className="text-caption-lg font-space-mono text-gray-500 mb-2 block">My Skills</span>
              <p className="text-body-base md:text-body-lg ">{t('internSkills')}</p>
            </div>
            <div>
              <span className="text-caption-lg font-space-mono text-gray-500 mb-2 block">Type</span>
              <p className="text-body-base md:text-body-lg ">{t('solo')}</p>
            </div>
            <div>
              <span className="text-caption-lg font-space-mono text-gray-500 mb-2 block">Deliverables</span>
              <p className="text-body-base md:text-body-lg ">{t('wireframes')}</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="flex flex-col md:flex-row justify-between">
          ...
          <div className="md:w-[80%]">
            ...
            <section id="overview" className="w-full mx-auto py-8   text-[#002a38]">
              {/* Heading: L_M_120 */}
              <h2 className="text-heading-xl md:text-heading-2xl font-merriweather mb-6">{t('overview')}</h2>

              {/* 残りのテキスト: Body/XL_140 */}
              <p className={`mb-6 ${bodyFont.className} ${jpFontSize('text-body-sm', 'text-body-lg')}`} style={bodyFont.style}>{t('overviewText')}</p>

              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mb-6">
                <div className="lg:col-span-6">
                  <p className={`mb-4 ${bodyFont.className} ${jpFontSize('text-body-sm', 'text-body-lg')}`} style={bodyFont.style}>
                    {t('scenarioIntro')}
                  </p>

                  <ul className={`space-y-2 mb-6 ${jpFontSize('text-body-sm', 'text-body-lg')}`}>
              ...
              <p className={`${bodyFont.className} ${jpFontSize('text-body-sm', 'text-body-lg')}`} style={bodyFont.style}>{t('internRole')}</p>
            </section>

            {/* Problem Section
            <section className="py-8">
              <h2 className="text-heading-xl md:text-heading-2xl font-merriweather mb-6">Problem</h2>
              <p className="mb-4 text-body-base md:text-body-lg ">
                Our user research process highlighted several potential challenges...
              </p>
              <ul className="list-disc pl-5 mb-4 space-y-2 text-body-base md:text-body-lg ">
            ...
            <section id="design-process" className="py-8">
              <h2 className="text-heading-xl md:text-heading-2xl font-merriweather mb-6">{t('designProcess')}</h2>
              <p className={`mb-4 ${bodyFont.className} ${jpFontSize('text-body-sm', 'text-body-lg')}`} style={bodyFont.style}>
                {t('designProcessText')}
              </p>
              <ol
                className={`list-decimal pl-5 mb-4 space-y-4 ${bodyFont.className} ${jpFontSize('text-body-sm', 'text-body-lg')}`} style={bodyFont.style}
              >
                <li>
            ...
            <section id="solution" className="py-8">
              <h2 className="text-heading-xl md:text-heading-2xl font-merriweather mb-6">{t('solution')}</h2>
              <div className="mb-8">
                <h3 className="text-heading-base font-merriweather mb-4">{t('conditionSearch')}</h3>
                <p className={`mb-4 ${bodyFont.className} ${jpFontSize('text-body-sm', 'text-body-lg')}`} style={bodyFont.style}>
              ...
              <div className="mb-8">
                <h3 className="text-heading-base font-merriweather mb-4">{t('searchResults')}</h3>
                <p className={`mb-4 ${bodyFont.className} ${jpFontSize('text-body-sm', 'text-body-lg')}`} style={bodyFont.style}>
              ...
              <div className="mb-8">
                <h3 className="text-heading-base font-merriweather mb-4">{t('sendRequest')}</h3>
                <p className={`mb-4 ${bodyFont.className} ${jpFontSize('text-body-sm', 'text-body-lg')}`} style={bodyFont.style}>
                  {t('sendRequestText')}
                </p>
                <div className="grid grid-cols-1 gap-4 mt-6">
            ...
            <section id="reflection" className="py-8">
              <h2 className="text-heading-xl md:text-heading-2xl font-merriweather mb-6">{t('reflection')}</h2>
              <div className="mb-6">
                <h3 className="text-heading-base font-merriweather mb-3">{t('impressions')}</h3>
                <ul className={`list-disc pl-5 space-y-2 ${bodyFont.className} ${jpFontSize('text-body-sm', 'text-body-lg')}`} style={bodyFont.style}>
              ...
              <div className="mb-6">
                <h3 className="text-heading-base font-merriweather mb-3">{t('reflectionTitle')}</h3>
                <ul className={`list-disc pl-5 space-y-2 ${bodyFont.className} ${jpFontSize('text-body-sm', 'text-body-lg')}`} style={bodyFont.style}>
                  ...
                  <button
                    ...
                    className={
                      activeSection === 'overview'
                        ? 'text-left text-body-xl font-roboto transition-transform duration-900 scale-110'
                        : 'text-left text-heading-sm font-roboto transition-transform duration-900 scale-100 opacity-50'
                    }
                  >
                    {t('overview')}
                  </button>
