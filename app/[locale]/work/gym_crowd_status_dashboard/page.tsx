    ...
    <div className="font-sans my-24 md:mt-28 md:mb-16">
        ...
        <div className="max-w-[1028px]  w-full mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div>
              ...
              <p className="text-body-lg tracking-[0.2px]">{t('projects.gymDashboard.timeline')}</p>
            </div>
            <div>
              <span className="text-caption-lg font-space-grotesk font-semibold text-ink-tertiary mb-2 block">My Skills</span>
              <p className="text-body-lg tracking-[0.2px]">{t('projects.gymDashboard.skills')}</p>
            </div>
            <div>
              <span className="text-caption-lg font-space-grotesk font-semibold text-ink-tertiary mb-2 block">Type</span>
              <p className="text-body-lg tracking-[0.2px]">{t('common.personalProject')}</p>
            </div>
            <div>
      ...
      <section className="py-8">
        <div className="max-w-[1028px] w-full mx-auto px-0 md:px-6">
          <div className="bg-surface-muted rounded-lg px-4 py-6 md:p-6 flex flex-col gap-6">
            <h2
              className={`text-title-lg text-ink ${getHeadingFontClass()}`}
            >
              TL;DR
            </h2>
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="flex-1  rounded-lg p-0 flex flex-col gap-2">
                  ...
                  >
                    <Waves className="w-6 h-6 text-ink" strokeWidth={2} />
                  </div>
                  <div className="flex flex-col gap-1">
                    <h3
                      className={`text-title text-ink ${getHeadingFontClass()}`}
                    >
                      Problem
                    </h3>
                    <p className="text-body-sm md:text-body-base font-helvetica-neue text-ink opacity-80 leading-[1.5]">
                      {t('tldr.problemText')}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex-1  rounded-lg p-0 flex flex-col gap-2">
                  ...
                  >
                    <Lightbulb className="w-6 h-6 text-ink" strokeWidth={2} />
                  </div>
                  <div className="flex flex-col gap-1">
                    <h3
                      className={`text-title text-ink ${getHeadingFontClass()}`}
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col md:flex-row gap-4 md:gap-6">
                  ...
                  <div className="flex-1 bg-white rounded-md p-4 flex flex-col gap-0">
                    ...
                    >
                      <Boxes className="w-6 h-6 text-ink" strokeWidth={2} />
                    </div>
                    <div className="flex flex-col justify-end items-end">
                      <span className="text-body-3xl font-helvetica-neue font-medium text-ink">
                        {isLoadingStats ? '...' : gymStats?.totalRecords || '354'}
                      </span>
                      <span className="text-body font-helvetica-neue text-ink leading-[1.5]">
                        {t('tldr.result1Label')}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex-1 bg-white rounded-md p-4 flex flex-col gap-0">
                    ...
                    >
                      <Server className="w-6 h-6 text-ink" strokeWidth={2} />
                    </div>
                    <div className="flex flex-col justify-end items-end">
                      <span className="text-body-3xl font-helvetica-neue font-medium text-ink text-right">
                        {isLoadingStats
                          ? '...'
                      ...
                      <span className="text-body-sm md:text-body-base font-helvetica-neue text-ink leading-[1.5] text-right">
                        {isLoadingStats
                          ? t('tldr.result2Label')
      ...
      <div className="max-w-7xl w-full mx-auto">
        <div className="flex flex-col md:flex-row justify-between">
          ...
          <div className="md:w-[80%]">
            {/* Overview Section */}
            <section id="overview" className="w-full mx-auto py-8   text-ink-secondary">
              <h2
                className={`text-title-lg mb-6 ${getHeadingFontClass()}`}
              >
                Overview
              </h2>

              <p
                className={`mb-6 ${getBodyFontClass()} tracking-[0.2px] text-body-lg`}
              >
                  ...
                  <div className="flex-shrink-0 w-6 h-6 md:w-8 md:h-8 flex items-center justify-center">
                    ...
                    >
                      <path
                        ...
                        fill="currentColor"
                        className="group-hover:fill-blue-600 transition-colors duration-150"
                      />
                    </svg>
                  </div>
                  {/* Repository Path */}
                  <div className="flex items-center gap-1">
                    <span className="text-body-sm md:text-body-lg leading-[1.25] font-normal text-ink-tertiary group-hover:text-blue-600 transition-colors duration-150">
                      iori73
                    </span>
                    <span className="text-body-sm md:text-body-lg leading-[1.25] font-normal text-ink-tertiary">/</span>
                    <span className="text-body-sm md:text-body-lg leading-[1.25] font-semibold text-ink group-hover:text-blue-600 transition-colors duration-150">
                      crowd_data_dashboard_v2
                    </span>
                  </div>
                  {/* External Link Icon */}
                  <MoveUpRight className="w-4 h-4 md:w-5 md:h-5 text-ink-tertiary group-hover:text-blue-600 transition-colors duration-150 flex-shrink-0" />
                </a>
              </div>
            </section>
            ...
            <section id="system-flow" className="py-8">
              {/* <h2 className="text-title-lg font-merriweather mb-6">
                {t('systemFlow')}
              </h2> */}
              <h3
                className={`text-title mb-4 ${getHeadingFontClass()}`}
              >
                System flow
              </h3>
              <div id="system-flow" className="mb-6">
                {/* <h3 className="text-2xl font-semibold text-gray-900 mb-2">{t('systemFlow')}</h3> */}
                <p className="text-body-lg text-ink-tertiary">{t('gymDashboard.systemFlowDescription')}</p>
              </div>
              ...
              <ul
                className={`list-disc pl-5 space-y-2 ${getBodyFontClass()} text-body-lg`}
              >
                <li>
                  {isLoadingStats
            ...
            <section id="design-process" className="py-8">
              ...
              <p
                className={`mb-4 ${getBodyFontClass()} tracking-[0.2px] text-body-lg`}
              >
                {t('gymDashboard.designProcessText')}
              </p>
              <div className="space-y-6 mb-4">
                <div>
                  <p className="font-switzer text-body-lg font-medium mb-2">
                    1. {t('gymDashboard.designStep1Title')}
                  </p>
                  <p className={`${getBodyFontClass()} tracking-[0.2px] text-body-lg`}>
            ...
            <section id="solution" className="py-8">
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 gap-4 mt-6">
                  ...
                  <Tabs defaultValue="before" className="w-full">
                    <TabsList className="grid w-full grid-cols-2 bg-surface-muted rounded-[10px] p-1 h-12 gap-1">
                      <TabsTrigger
                        value="before"
                    ...
                    <TabsContent value="before" className="mt-4">
                      <div className="flex flex-col">
                        ...
                        <Alert className="rounded-b-[10px] rounded-t-none border-t-0 border-line-subtle [&>svg]:text-red-600 [&>svg]:relative [&>svg]:left-0 [&>svg]:top-0">
                          <div className="flex items-center gap-3">
                            <CircleAlert className="h-5 w-5 md:h-6 md:w-6 text-red-600 shrink-0" />
                            <AlertTitle className="text-red-600 text-body-sm md:text-body-lg mb-0 font-medium">
                              Initial design
                            </AlertTitle>
                          </div>
                          <AlertDescription className="text-red-600 text-body-sm mt-2 pl-7">
              ...
              <div className="mb-8">
                ...
                <ol
                  className={`list-decimal pl-5 mb-4 space-y-2 font-helvetica-neue text-body-lg`}
                >
                  <li>
              ...
              <div className="mb-8">
                ...
                <div className="mb-4">
                  <p className={`${getBodyFontClass()} text-body-lg font-medium`}>
                    {t('gymDashboard.failureHistory')}
                  </p>
                  <ul
                    className={`list-disc pl-5 space-y-1 ${getBodyFontClass()} text-body-lg`}
                  >
                    <li>
                ...
                <div className="mb-4">
                  ...
                  <p
                    className={`mb-2 ${getBodyFontClass()} tracking-[0.2px] text-body-lg`}
                  >
                ...
                <div className="mb-4">
                  ...
                  <ol
                    className={`list-decimal pl-5 space-y-1 ${getBodyFontClass()} text-body-lg`}
                  >
                    <li>
            ...
            <section id="impact-reflection" className="py-8">
              ...
              <div className="mb-6">
                <h3
                  className={`text-title mb-3 ${getHeadingFontClass()}`}
                >
