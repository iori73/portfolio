...
const basePlugins: PluginData[] = [
  {
    ...
    accentColor: '#1ABCFE',
    iconImage: '/work/figma-plugins/pptx-icon.webp',
    thumbnail: '/work/figma-plugins/pptx-cover.webp',
    users: 10200,
    likes: 100,
  },
  {
    ...
    accentColor: '#A259FF',
    iconImage: '/work/figma-plugins/pm-icon.webp',
    thumbnail: '/work/figma-plugins/pm-cover.webp',
    users: 707,
    likes: 13,
  },
  {
    ...
    accentColor: '#0ACF83',
    iconImage: '/work/figma-plugins/bsi-icon.webp',
    thumbnail: '/work/figma-plugins/bsi-cover.webp',
    users: 36,
    likes: 0,
  },
];
